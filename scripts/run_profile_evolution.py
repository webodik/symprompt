#!/usr/bin/env python
"""
Profile evolution runner.

Evolves the SymIL profiles (domain vocabularies, solver preferences).

Usage:
    EVOLVE_LLM_MODEL="openrouter/x-ai/grok-4.1-fast:free" \
    EVOLVE_ITERATIONS=100 \
    .venv/bin/python scripts/run_profile_evolution.py
...
def main() -> None:
    ...
    sys.argv = ["run_profile_evolution"]
    if iterations_str:
    ...
    # Import and run
    from symprompt.evolution.run_profile_evolution import main as run_main
    run_main()
