#!/usr/bin/env python
"""
Router evolution runner.

Evolves the SmartRouter component (tier/profile selection).

Usage:
    EVOLVE_LLM_MODEL="openrouter/x-ai/grok-4.1-fast:free" \
    EVOLVE_ITERATIONS=100 \
    .venv/bin/python scripts/run_router_evolution.py
...
def main() -> None:
    ...
    # Import and run
    from symprompt.evolution.run_router_evolution import main as run_main
    run_main()
